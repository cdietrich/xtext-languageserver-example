...
var vscode_jsonrpc = require('vscode-jsonrpc');
function activate(context) {
    ...
    var lc = new vscode_lc.LanguageClient('Xtext Server', serverInfo, clientOptions);
    lc.trace = vscode_jsonrpc.Trace.Verbose;
